    ...
    quality: {
      ...
      items: [
        { title: "تطوير أداء الهيئة التعليمية", weight: "—", clauses: [
          { title: "تقنيات حديثة داعمة للتعليم", pdf: "", file: "" },
          { title: "برامج نمو مهني للمعلمين", pdf: "", file: "" },
          { title: "زيارات إشرافية وتغذية راجعة", pdf: "", file: "" },
          { title: "التزام بتنفيذ الخطط التعليمية", pdf: "", file: "" },
          { title: "تحسن أداء الهيئة التعليمية", pdf: "", file: "" },
          { title: "تنوع أساليب واستراتيجيات التدريس", pdf: "", file: "" },
          { title: "أساليب تحفيز للكادر التعليمي", pdf: "", file: "" },
          { title: "تنمية مهارات وقدرات المعلمين", pdf: "", file: "" },
          { title: "توظيف الموارد التعليمية بكفاءة", pdf: "", file: "" },
        ]},
        { title: "التحصيل الدراسي", weight: "—", clauses: [
          { title: "تحليل بيانات الوزارة للتحصيل", pdf: "", file: "" },
          { title: "تحليل دوري لنتائج التحصيل", pdf: "", file: "" },
          { title: "إجراءات داعمة لرفع التحصيل", pdf: "", file: "" },
          { title: "خطط رفع المستوى الدراسي", pdf: "", file: "" },
          { title: "مراكز متقدمة على مستوى المحافظة", pdf: "", file: "" },
          { title: "توظيف الوسائل والمصادر للتعلم", pdf: "", file: "" },
          { title: "آلية تحفيز الطلبة المتفوقين", pdf: "", file: "" },
        ]},
        { title: "الأنشطة المدرسية والرعاية الطلابية", weight: "—", clauses: [
          { title: "حصر فئات الرعاية الطلابية", pdf: "", file: "" },
          { title: "برامج دعم للدمج والمستويات", pdf: "", file: "" },
          { title: "مشاركة في مسابقات وأنشطة", pdf: "", file: "" },
          { title: "بيئة مدرسية داعمة وآمنة", pdf: "", file: "" },
          { title: "فعاليات وأنشطة متنوعة", pdf: "", file: "" },
          { title: "إبراز المواهب والإنجازات", pdf: "", file: "" },
          { title: "تكريم فئات الرعاية المختلفة", pdf: "", file: "" },
          { title: "الالتزام بضوابط الأنشطة وتوثيقها", pdf: "", file: "" },
          { title: "أنشطة لا منهجية منظّمة", pdf: "", file: "" },
          { title: "احتفالات مناسبات وطنية ودينية", pdf: "", file: "" },
          { title: "توجيه الأنشطة للقيم والسلوك", pdf: "", file: "" },
          { title: "نشر ثقافة العمل التطوعي", pdf: "", file: "" },
        ]},
      ],
    },
    partnership: {
      ...
      items: [
        { title: "الشراكة المجتمعية", weight: "—", clauses: [
          { title: "تفعيل مجلس أولياء الأمور واجتماعاته", pdf: "", file: "" },
          { title: "مساهمة المجلس برفع التحصيل", pdf: "", file: "" },
          { title: "مشاركة أولياء الأمور في الأنشطة", pdf: "", file: "" },
          { title: "شراكات لمشروعات الاستدامة", pdf: "", file: "" },
          { title: "توظيف خبرات ومهارات أولياء الأمور", pdf: "", file: "" },
          { title: "مشاركة في حل مشكلات الطلبة", pdf: "", file: "" },
          { title: "شراكات مع مؤسسات المجتمع المحلي", pdf: "", file: "" },
          { title: "مبادرات مجتمعية مؤثرة", pdf: "", file: "" },
          { title: "دعم تعلم الطلبة وتحسين البيئة", pdf: "", file: "" },
        ]},
      ],
    },
  };
